...
//	std::queue <const GraphNode*> q;	//検討ノード
//	q.emplace(start);
//
//	while (!q.empty()) {
//		const GraphNode* current = q.front();
//		q.pop();
//		if (current == goal) {	//探索成功
//			pathFound = true;
//			break;
//		}
//		for (const GraphNode* node : current->mAdjacent) {	//自分の周りにあるnodeを順にチェック
//			const GraphNode* parent = outMap[node];	//自分の経路過程のnodeを代入
...
//	bool mlnOpenSet = false;
//	bool mlnClosedSet = false;
//};
//
...
//		current = *iter;
//		openSet.erase(iter);
//		outMap[current].mlnOpenSet = false;
//		outMap[current].mlnOpenSet = true;
//	} while (current != goal);
//	
